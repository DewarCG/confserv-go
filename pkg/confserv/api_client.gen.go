...
// GetSettingByNameParams defines parameters for GetSettingByName.
...
type ClientInterface interface {
	...
	// GetSettingByName request
	GetSettingByName(ctx context.Context, name string, params *GetSettingByNameParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	DeleteSetting(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetSetting request
	GetSetting(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetSettingByName(ctx context.Context, name string, params *GetSettingByNameParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSettingByNameRequest(c.Server, name, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteSetting(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteSettingRequest(c.Server, app, scope, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetSetting(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetSettingRequest(c.Server, app, scope, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetSettingByNameRequest generates requests for GetSettingByName
func NewGetSettingByNameRequest(server string, name string, params *GetSettingByNameParams) (*http.Request, error) {
	var err error
...
func NewDeleteSettingRequest(server string, app string, scope string, name string) (*http.Request, error) {
	var err error
...
func NewGetSettingRequest(server string, app string, scope string, name string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetSettingByName request
	GetSettingByNameWithResponse(ctx context.Context, name string, params *GetSettingByNameParams, reqEditors ...RequestEditorFn) (*GetSettingByNameResponse, error)
	...
	// DeleteSetting request
	DeleteSettingWithResponse(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*DeleteSettingResponse, error)

	// GetSetting request
	GetSettingWithResponse(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*GetSettingResponse, error)
}
...
type GetSettingByNameResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r GetSettingByNameResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetSettingByNameResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetSettingByNameWithResponse request returning *GetSettingByNameResponse
func (c *ClientWithResponses) GetSettingByNameWithResponse(ctx context.Context, name string, params *GetSettingByNameParams, reqEditors ...RequestEditorFn) (*GetSettingByNameResponse, error) {
	rsp, err := c.GetSettingByName(ctx, name, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetSettingByNameResponse(rsp)
}
...
func (c *ClientWithResponses) DeleteSettingWithResponse(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*DeleteSettingResponse, error) {
	rsp, err := c.DeleteSetting(ctx, app, scope, name, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetSettingWithResponse(ctx context.Context, app string, scope string, name string, reqEditors ...RequestEditorFn) (*GetSettingResponse, error) {
	rsp, err := c.GetSetting(ctx, app, scope, name, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseGetSettingByNameResponse parses an HTTP response from a GetSettingByNameWithResponse call
func ParseGetSettingByNameResponse(rsp *http.Response) (*GetSettingByNameResponse, error) {
	bodyBytes, err := ioutil.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetSettingByNameResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
